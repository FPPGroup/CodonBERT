...
def set_args():
    ...
    parser.add_argument('-f', '--fasta', help='mRNA fasta',required = True, type = str)             #添加可选参数，以--开头，如果没有以这个开头，就会报错
...
if __name__ == '__main__':
    ...
    ## cai
    command_line = env_path+"/bin/_cai -seqall %s -cfile Ehuman.cut -outfile %s" % (fasta_path, temp_file) # Ehuman.cut is default
